...
var createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn = require('./createRuntimeFn-d16e1ead.cjs.prod.js');
...
function createStyles(property, scale, conditions, defaultCondition) {
  ...
  if (!conditions) {
    ...
    var styleValue = createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, property, cssVar);
    var className = css.style(options['@layer'] ? createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, '@layer', createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, options['@layer'], styleValue)) : styleValue, property);
    return {
      vars: {
        "default": cssVar
      },
  ...
  var classes = createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn.mapValues(conditions, function (conditionValue, conditionName) {
    ...
    return css.style(options['@layer'] ? createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, '@layer', createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, options['@layer'], styleValue)) : styleValue, "".concat(property, "-").concat(conditionName));
  });
  return {
    dynamic: {
...
function createStaticStyles(property, scale, conditions, defaultCondition) {
  ...
  var values = createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn.mapValues(scaleObj, function (scaleValue, scaleKey) {
    ...
    if (!conditions) {
      return {
        "default": css.style(options['@layer'] ? createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, '@layer', createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, options['@layer'], styleValue)) : styleValue, "".concat(property, "-").concat(scaleKey))
      };
    }
    var classes = createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn.mapValues(conditions, function (conditionValue, conditionName) {
      var styleValue = createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, property, scaleValue);
      ...
      return css.style(options['@layer'] ? createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, '@layer', createRuntimeFn_dist_rainbowSprinklesCreateRuntimeFn._defineProperty({}, options['@layer'], styleValue)) : styleValue, "".concat(property, "-").concat(scaleKey, "-").concat(conditionName));
    });
    return {
      conditions: classes,
      "default": classes[defaultCondition]
