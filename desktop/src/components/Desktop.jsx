...
export default function Desktop(props) {
  ...
  const handleOpenFlashcard = props.openFlashcardApp;
  const handleOpenSWECards = props.openSWECards;
  ...
  return (
      <div className="desktop-icons">
          ...
          <div
              className={activeIcon === 8 ? "active-icon" : "inactive-icon"}
              onClick={() => handleToggleIcon(8)}
              onDoubleClick={handleOpenSWECards}
          >
              <Access230 variant="32x32_4"/>
              <p>Exam 1 Study</p>
          </div>
          <div
              className={activeIcon === 9 ? "active-icon" : "inactive-icon"}
              onClick={() => handleToggleIcon(9)}
              onDoubleClick={handleOpenFlashcard}
          >
              <Access230 variant="32x32_4"/>
              <p>Feedback</p>
          </div>
